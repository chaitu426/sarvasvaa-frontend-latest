        ...
        <section className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-sm">
              <p>
                Total Collected:{" "}
                <strong>{monthlyData?.milk_collected?.total_quantity ?? 0} L</strong>
              </p>
              <p>
                Total Cost:{" "}
                <strong>₹{monthlyData?.milk_collected?.total_cost ?? 0}</strong>
              </p>
              <p>
                Avg Cost/Litre:{" "}
                <strong>
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div>
                Total Sold:{" "}
                <strong>{monthlyData?.sales?.total_quantity ?? 0} units</strong>
              </div>
              <div>
                Revenue:{" "}
                <strong>₹{monthlyData?.sales?.total_revenue ?? 0}</strong>
              </div>
              <div>
                Unpaid:{" "}
